...
import dynamic from 'next/dynamic'; // 🚀 प्रिरेंडर लूप को हमेशा के लिए उड़ाने वाला आधिकारिक टूल

// 🏆 Next.js का आधिकारिक कड़क डायनेमिक रूल
export const dynamicConfig = 'force-dynamic';
export const prerender = false;

// ⚡ भारी विज़ुअल कम्पोनेंट्स को No-SSR (Server-Side Rendering = False) के साथ डायनेमिकली लोड करना
const Hero = dynamic(() => import('@/components/luxury/Hero'), { ssr: false });
const ThreeDFood = dynamic(() => import('@/components/luxury/ThreeDFood'), { ssr: false });
const LiveCooking = dynamic(() => import('@/components/wow/LiveCooking'), { ssr: false });
const WinePairing = dynamic(() => import('@/components/wow/WinePairing'), { ssr: false });
const SpinWin = dynamic(() => import('@/components/wow/SpinWin'), { ssr: false });
